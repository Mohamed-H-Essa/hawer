...
import 'package:hawer_app/app/home_pages/feedback_pages/feedback%203.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: AnimatedSplashScreen(
          splash :
          //"images/splashicon.jpeg",
          Text("حاوِر",style: TextStyle(color:Constants.darkBlue,fontSize: 60,fontWeight: FontWeight.bold),),
          splashIconSize: 100,
          duration: 900,
