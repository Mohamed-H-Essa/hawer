...
class _SettingsState extends State<Settings> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      AppBar(title: const Text ("حاوِر",style: TextStyle(fontSize: 30),),
        centerTitle: true,
            ...
            SizedBox(
              ...
              child: MaterialButton(onPressed: (){
                ...
                child: const Row(
                  ...
                  children: [
                    Text("من نحن",style: TextStyle(fontSize: 16,color: Colors.white),),
            ...
            SizedBox(
              ...
              child: MaterialButton(onPressed: (){
                ...
                child: const Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("تواصل معنا",style: TextStyle(fontSize: 16,color: Colors.white),),
                    Icon(CupertinoIcons.forward,color: Colors.white,),
                  ],
                ),
              ),
            ...
            SizedBox(
              ...
              child: MaterialButton(onPressed: (){
                ...
                child: const Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("رؤيتنا",style: TextStyle(fontSize: 16,color: Colors.white),),
                    Icon(CupertinoIcons.forward,color: Colors.white,),
            ...
            SizedBox(
              ...
              child: MaterialButton(onPressed: (){
                ...
                child: const Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("شروط الاستخدام",style: TextStyle(fontSize: 16,color: Colors.white),),
                    Icon(CupertinoIcons.forward,color: Colors.white,),
